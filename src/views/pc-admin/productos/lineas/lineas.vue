...
// OLD
    ...
    async uploadImg(CodigoImportadora, Importadora){
      if(this.file.size < 1000000 && this.file.name.split('.')[1] == 'jpg' || this.file.size < 1000000 && this.file.name.split('.')[1] == 'jpeg'){
        ...
        this.productoSeleccionado.CurrentImg = 'http://localhost:3000/repuestos/' + this.productoSeleccionado.CodigoImportadora + '.jpg?version=' + this.imgUpdate;
    ...
    if(Accion == 'asignar'){
        ...
        this.productoSeleccionado.CurrentImg = 'http://localhost:3000/repuestos/default.jpg';
    }
    },
    ...
    async marketplace(producto){
        if(producto.CurrentImg[0] != 'h'){
            producto.CurrentImg = 'http://localhost:3000/repuestos/' + producto.CurrentImg + '.jpg';
        }
        this.productoSeleccionado = producto
